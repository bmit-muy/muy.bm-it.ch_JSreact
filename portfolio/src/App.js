...
import { Age, SList } from './Components/SpecialData';
...
<Navigation></Navigation>
  ...
  <h1 className='App-massage' id='About' >About Me</h1>
  ...
  <h1 className='App-massage' id='know_how'> Know How</h1>
  <SList />

  <h1 className='App-massage' id='protjects'>Protjects</h1>

  <footer className='App-footer' id='Contact'>
    <p>
      <p>Autor: Yannick Müller </p>
      <p>Made using: Visual Studio Code </p>
      <p></p>
      <br></br>
      <Footer></Footer>
    </p>
